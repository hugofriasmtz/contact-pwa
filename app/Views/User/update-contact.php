  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <?php echo $struct_controller->UserSidebarMenu('update-contact') ?>
      </aside>
      <!-- / Menu -->
        ...
        <nav
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="nav nav-pills flex-column flex-md-row ">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="javascript:void(0);"><i class="bx bxs-user-check bx-sm me-1_5"></i> Actualizar</a>
              </li>
            </ul>
            <!-- /Search -->
                        ...
                        <div class="d-flex mb-4 align-items-center">
                          ...
                          <div class="flex-grow-1 row">
                            <div class="col-7">
                              ...
                              <a href="https://twitter.com/Theme_Selection" target="_blank" class="small">@ThemeSelection</a>
                            </div>
                            <div class="col-5 text-end mt-sm-0 mt-2">
